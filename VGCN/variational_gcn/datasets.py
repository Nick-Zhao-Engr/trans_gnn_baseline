...
def get_data(
    ...
    '''the return type of A,X and y are all np array'''
    ...
    if random_split:
        ...
        elif dataset_name.startswith('fb'):
            indices = load_fb100_split(dataset_name)
...
DATASET_LOADERS = dict(
    ...
    fb_amherst=partial(load_fb100,'fb_amherst'),
    fb_jh=partial(load_fb100,'fb_jh'),
)
