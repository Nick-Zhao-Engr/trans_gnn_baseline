...
class UCI(ConfigData):
    ...
    def load(self, data_dir=None, knn_size=None, epsilon=None, knn_metric='cosine', node_remove=0):
        ...
        if self.dataset_name == 'iris':
            ...
            path='../../../data/mini_imagenet/mini_imagenet.pkl'
            ...
            self.n_train=int(n_node*train_portion)
            self.n_val=int(n_node*val_portion)
        ...
        if self.dataset_name.startswith('mini'):
            pass 
        elif self.dataset_name != 'fma':
